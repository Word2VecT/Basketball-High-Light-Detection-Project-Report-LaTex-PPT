...
if __name__ == "__main__":
    ...
    smoother = MergedAdaptiveJumpRemover(
        input_json_path="/data/ljy23/project/code/test1/segment_000_frames_3200_3400/traj_reid/traj_reid/merged_trajectories_with_player_id_3200-3400frames.json",
        output_json_path="/data/ljy23/project/code/test1/segment_000_frames_3200_3400/traj_smooth/smoothed_trajectories.json",
        vis_image_path="/data/ljy23/project/code/test1/segment_000_frames_3200_3400/traj_smooth/smoothed_trajectories.png",
